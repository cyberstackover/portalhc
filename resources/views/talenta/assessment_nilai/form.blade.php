	...
	<div class="kt-portlet__body">
		...
		<div class="row">	
			...
			<div class="col-lg-12">
				<div class="alert alert-custom fade show mb-5" style="background-color:yellow;" role="alert">
					<div class="alert-text"><b>Ketentuan Kesimpulan Qualified :</b><br>
						<p>
						1. Aspek Kompetensi yang mendapat rating 2 berjumlah maksimal 3 aspek<br>
						2. Tidak ada Kompetensi yang mendapat rating 1<br>
						3. Seluruh aspek Kualifikasi Profesional minimal mendapat rating 2
						</p>
					</div>
			...
			<div class="div-qualified" style="{{(@$data->hasil=='Qualified') ? '':'display:none;' }}">				
				...
				<div class="col-lg-12">
					<div class="form-group">
						<label><b>II. Sektor/Klaster BUMN</b> (Pilih Maksimal 5)</label>
						<br/>
						<br/>
						<div class="form-group row">
				...
				<div class="col-lg-12">
					<div class="form-group">
						<label><b>III. Keahlian Bidang/Fungsi</b> (Pilih Maksimal 3)</label>
						<br/>
						<br/>
				...
				<div class="col-lg-12">
					<div class="form-group">
						...
						<div class="form-group row">
							<textarea class="form-control kt-shape-bg-color-1" id="area_kekuatan" name="area_kekuatan" rows="5" cols="5">{{($actionform === 'update') ? $assessment_nilai->area_kekuatan : ''}}</textarea>
						</div>
					</div>
				</div>
				<div class="col-lg-12">
					<div class="form-group">
						...
						<div class="form-group row">
							<textarea class="form-control kt-shape-bg-color-1" id="area_pengembangan" name="area_pengembangan" rows="5" cols="5">{{($actionform === 'update') ? $assessment_nilai->area_pengembangan :'' }}</textarea>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function checkCluster(element) {
		...
		if(arrayfilter.length>5){
			swal.fire({
                        title: "Warning",
                        html:'Pilihan Cluster BUMN Maksimal 5',
                        type: 'warning',
	...
	function checkKeahlian(element) {
		...
		if(arrayfilter.length>3){
			swal.fire({
                        title: "Warning",
                        html:'Pilihan Keahlian Bidang/Fungsi Maksimal 3',
                        type: 'warning',
