<form class="kt-form kt-form--label-right" method="POST" id="form-angkatlagi-anak">
	@csrf
	...
	<div class="kt-portlet__body">
		<div class="form-group row">
			<div class="col-lg-6">
				<label>Nama</label>
				<select class="form-control kt-select2" id="id_talenta" name="id_talenta" required="required" onchange=" return onTglJabat(this.value, {{ $id_perusahaan }}) ">
                    <option value=""></option>
		...
		<div class="form-group row">
			<div class="col-lg-4">
				<label>Periode</label>
				<select class="form-control kt-select2" required="required" name="id_periode_jabatan">
			...
			<div class="col-lg-4">
				...
				<input type="text" class="form-control cls-datepicker" name="tanggal_awal_menjabat" required="required" id="tanggal_awal_menjabat" value="{{!empty(old('tanggal_awal_menjabat'))? old('tanggal_awal_menjabat') : ($actionform == 'update' && $skangkat->tanggal_awal_menjabat != ''? \Carbon\Carbon::createFromFormat('Y-m-d', $skangkat->tanggal_awal_menjabat)->format('d/m/Y') : old('tanggal_awal_menjabat'))}}" />
			</div>
			<div class="col-lg-4">
...
<script type="text/javascript" src="{{asset('js/administrasi/anak/formangkatlagi.js')}}"></script>