<form class="kt-form kt-form--label-right" method="POST" id="form-alt">
	@csrf
	...
	<div class="kt-portlet__body">
		<div class="form-group row">
			...
			<div class="col-lg-6">
				<label>Nama</label>
				<select class="form-control kt-select2" name="id_talenta" onchange=" return onTglJabat(this.value, {{ $id_perusahaan }}) ">
                    <option value=""></option>
...
<script type="text/javascript" src="{{asset('js/administrasi/bumn/formalt.js')}}"></script>
