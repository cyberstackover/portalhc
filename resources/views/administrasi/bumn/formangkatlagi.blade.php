<form class="kt-form kt-form--label-right" method="POST" id="form-angkatlagi">
	@csrf
...
<script type="text/javascript" src="{{asset('js/administrasi/bumn/formangkatlagi.js')}}"></script>