										...
										<div class="dropdown dropdown-inline">
											...
											<div class="dropdown-menu dropdown-menu-right" style="">
												<ul class="kt-nav">
													...
													<li class="kt-nav__item">
														<a href="#" class="kt-nav__link cls-add-jabatan-klatur">
															<i class="kt-nav__link-icon flaticon2-group"></i>
															<span class="kt-nav__link-text">Tambah Jabatan</span>
														</a>
													</li>
													<li class="kt-nav__item">
														<a href="#" class="kt-nav__link cls-hapus-jabatan-klatur">
															<i class="kt-nav__link-icon flaticon2-trash "></i>
															<span class="kt-nav__link-text">Hapus Jabatan</span>
														</a>
													</li>
													<li class="kt-nav__item">
														<a href="/administrasi/bumn/{{$id_surat_keputusan}}/edittambah" class="kt-nav__link ">
